set :application, "kitchenaidclub"
set :repository,  "git@github.com:zufrieden/kitchenaidclub.git"
set :scm,         :git

# set :scm, :git # You can set :scm explicitly or Capistrano will make an intelligent guess based on known version control directory names
# Or: `accurev`, `bzr`, `cvs`, `darcs`, `git`, `mercurial`, `perforce`, `subversion` or `none`

set :deploy_to,   "/home/mfh/www/kitchenaidclub.com/"
set :user,        "mfh"
set :domain,      "antistatique"
set :use_sudo,    false

role :app, 'kitchenaidclub.com'
role :web, 'kitchenaidclub.com'
